...
describe('normalizeRoomPlanVisionKind', () => {
  it('reconnaît les kinds canoniques et les alias FR / EN', () => {
    ...
    assert.equal(normalizeRoomPlanVisionKind('ordercounter'), 'orderCounter');
    assert.equal(normalizeRoomPlanVisionKind('pickupcounter'), 'pickupCounter');
    assert.equal(normalizeRoomPlanVisionKind('pizzaoven'), 'pizzaOven');
    assert.equal(normalizeRoomPlanVisionKind('kitchenline'), 'kitchenLine');
    assert.equal(normalizeRoomPlanVisionKind('kitchen'), 'zone');
    assert.equal(normalizeRoomPlanVisionKind('restroom'), 'zone');
    assert.equal(normalizeRoomPlanVisionKind('stylingstation'), 'stylingStation');
    assert.equal(normalizeRoomPlanVisionKind('washbasin'), 'washBasin');
    assert.equal(normalizeRoomPlanVisionKind('condimentstation'), 'condimentStation');
    assert.equal(normalizeRoomPlanVisionKind('loungesofa'), 'loungeSofa');
    assert.equal(normalizeRoomPlanVisionKind('car'), 'car');
