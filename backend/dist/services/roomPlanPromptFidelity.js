...
exports.ROOM_PLAN_BRIEF_REFORMULATION_SYSTEM = void 0;
exports.buildRoomPlanEnglishSceneBriefScaffold = buildRoomPlanEnglishSceneBriefScaffold;
exports.buildRoomPlanBriefReformulationUserText = buildRoomPlanBriefReformulationUserText;
exports.parseRoomPlanEnglishSceneBriefFromJson = parseRoomPlanEnglishSceneBriefFromJson;
exports.processRoomPlanBrief = processRoomPlanBrief;
exports.applyRoomPlanEnglishSceneBrief = applyRoomPlanEnglishSceneBrief;
function collapseSpaces(value) {
    return value.replace(/[ \t]+/g, ' ').replace(/\n{3,}/g, '\n\n').trim();
}
/** System prompt for Gemini room-plan brief reformulation. */
exports.ROOM_PLAN_BRIEF_REFORMULATION_SYSTEM = `You rewrite venue floor-plan briefs for Gemini (EventMaster reception architect, Central Africa / RDC).
 ...
 */
function buildRoomPlanEnglishSceneBriefScaffold(brief, options) {
    ...
    const sizeBit = typeof widthM === 'number' && typeof heightM === 'number'
        ? `${widthM} m × ${heightM} m`
    ...
    let subject = 'a lived-in banquet reception floor plan with clear circulation and a ceremonial focal point';
...
function buildRoomPlanBriefReformulationUserText(originalBrief, options) {
    const roomType = options?.roomType || 'BANQUET';
    const size = typeof options?.widthM === 'number' && typeof options?.heightM === 'number'
...
function parseRoomPlanEnglishSceneBriefFromJson(raw) {
...
function processRoomPlanBrief(brief, options) {
...
function applyRoomPlanEnglishSceneBrief(processed, englishSceneBrief) {
