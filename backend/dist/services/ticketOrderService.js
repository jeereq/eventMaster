...
async function fulfillTicketOrder(orderId, stripeSession) {
    ...
    if (isDonation) {
        ...
        ${donationMeta?.donationNote ? `<div style="margin:0 0 16px;padding:12px 14px;background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;font-size:14px;color:#475569;font-style:italic;">« ${(0, brandingUtils_1.escapeHtml)(String(donationMeta.donationNote))} »</div>` : ''}
