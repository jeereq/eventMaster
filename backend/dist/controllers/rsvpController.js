      ...
      `;
            ...
            (async () => {
                try {
                    ...
                    await (0, notificationService_1.sendRealEmail)(owner.email, ownerSubject, ownerTextBody, ownerHtmlBody);
                    ...
                    if (ownerPhone) {
                        ...
                        await (0, notificationService_1.sendRealWhatsApp)(ownerPhone, ownerWhatsappBody);
                    }
                }
                catch (ownerNotifErr) {
