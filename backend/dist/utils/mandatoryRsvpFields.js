...
exports.MANDATORY_RSVP_FIELD_PRESETS = void 0;
exports.ensureMandatoryRsvpFields = ensureMandatoryRsvpFields;
exports.parseEventRsvpForm = parseEventRsvpForm;
exports.overlayRsvpFieldsOnContent = overlayRsvpFieldsOnContent;
exports.ensureMandatoryRsvpFieldsOnContent = ensureMandatoryRsvpFieldsOnContent;
const MANDATORY_RSVP_KEY_ALIASES = {
...
exports.MANDATORY_RSVP_FIELD_PRESETS = [
    {
        id: 'mandatory_genre',
        type: 'radio',
        label: 'Genre',
...
function fieldMatchesMandatoryKey(field, canonicalKey) {
...
function parseEventRsvpForm(raw) {
    if (!raw)
        return [];
    if (Array.isArray(raw))
        return raw;
    if (typeof raw === 'object' && Array.isArray(raw.fields)) {
        return raw.fields;
    }
    return [];
}
function overlayRsvpFieldsOnContent(content, eventForm) {
...
function ensureMandatoryRsvpFieldsOnContent(content) {
