...
router.get('/tenants/:id/ops', adminOpsController_1.getTenantOps);
router.post('/tenants/:id/impersonate', adminOpsController_1.impersonateTenant);
...
router.patch('/catalog/bookings/:id/commission', adminCatalogController_1.settleMarketplaceCommission);
router.patch('/catalog/venues/:id/visibility', adminCatalogController_1.setVenueListingVisibility);
