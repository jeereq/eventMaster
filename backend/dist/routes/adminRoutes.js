...
const adminSubscriptionReportController_1 = require("../controllers/adminSubscriptionReportController");
const eventPayoutController_1 = require("../controllers/eventPayoutController");
...
router.get('/reports/subscriptions', (0, auth_1.requireRole)(['SUPER_ADMIN', 'COMMERCIAL']), adminSubscriptionReportController_1.getAdminSubscriptionReport);
router.get('/reports/subscriptions/export', (0, auth_1.requireRole)(['SUPER_ADMIN', 'COMMERCIAL']), adminSubscriptionReportController_1.exportAdminSubscriptionReport);
router.post('/subscriptions/manage', (0, auth_1.requireRole)(['SUPER_ADMIN']), adminSubscriptionReportController_1.manageAdminSubscription);
router.get('/reports/event-payouts', (0, auth_1.requireRole)(['SUPER_ADMIN']), eventPayoutController_1.getAdminEventPayoutsReport);
router.get('/reports/event-payouts/export', (0, auth_1.requireRole)(['SUPER_ADMIN']), eventPayoutController_1.exportAdminEventPayoutsReport);
router.post('/reports/event-payouts/:eventId/settle', (0, auth_1.requireRole)(['SUPER_ADMIN']), eventPayoutController_1.settleAdminEventPayout);
