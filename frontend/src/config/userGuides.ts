...
export const USER_GUIDES: UserGuide[] = [
  {
    ...
    workflows: [
      ...
      },
      {
        ...
        content:
          '1. Ouvrez Catalogue.\n2. Filtrez salles, prestataires ou matériel & équipements. Dépublier exige un motif (journalisé) ; Republier remet la fiche en vitrine.\n3. Les compteurs GMV distinguent salles, prestataires et matériel & équipements ; favoris et packs mesurent l’usage de « Préparer un événement ».\n4. Onglet Commissions {commissionPercent} % : marquez payée après versement hors plateforme, ou exportez le CSV.',
  ...
  },
  {
    ...
    canDo: [
      ...
      'Explorer le catalogue acheteur (comme un client) : salles, prestataires, matériel & équipements',
  ...
  },
  {
    ...
    badge: 'Organisation',
    summary:
      'Accueil jour J : tableau de bord, scan QR, tâches, catalogue et réalisations. Vous consultez le contexte de l’événement — vous ne créez pas de modèles, de plans de salle, ni ne changez le type de compte.',
    canDo: [
      ...
      'Consulter les réalisations des salles et prestations',
      'Consulter Demandes de devis et Réservations',
      'Statistiques d’accueil (check-in, tâches)',
    ],
    cannotDo: [
      'Changer le type de compte de l’organisation',
      'Créer des événements, des salles ou des plans de salle (à la main ou par IA)',
      'Créer ou modifier des modèles d’invitation (à la main ou par IA)',
    ...
    workflows: [
      ...
      {
        id: 'protocol-realisations',
        title: 'Voir les réalisations',
        content:
          '1. Ouvrez Réalisations depuis le menu ou l’accueil.\n2. Filtrez salles / prestations, passez de la grille au fil.\n3. Touchez une carte pour le détail et la fiche du partenaire.\n4. Vous consultez uniquement : la création de posts, de modèles et de plans reste au propriétaire.',
        links: [{ label: 'Réalisations', href: '/dashboard/publications' }],
      },
      {
  ...
  },
  {
    ...
    workflows: [
      ...
      },
      {
        ...
        content:
          '1. Ouvrez Marketplace.\n2. Onglet Explorer : filtrez par mot-clé, ville, commune, type (salles / prestataires / matériel & équipements / événements), prestataire ou matériel & équipements (habits, véhicules, sonorisation), prix, places.\n3. Passez en grille, liste, carte ou Focus (plein écran). Les pastilles indiquent Salle, Presta, Matériel ou Évén.\n4. Cliquez sur le cœur d’une salle, d’un prestataire ou d’un équipement.\n5. Onglet Favoris : filtrez salles / prestataires / matériel & équipements et changez la vue.\n6. Bouton Partager : copie l’URL actuelle, avec vos filtres.',
