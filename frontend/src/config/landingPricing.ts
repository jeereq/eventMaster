...
export const LANDING_PLANS: LandingPlan[] = [
  {
    ...
    tier: 'essentials',
    audience: 'B2B',
    highlights: ['3 événements · 50 invités', '4 essais IA offerts, puis jetons', 'Invitations, RSVP, QR, PDF/GPS', '1 salle simple · 1 prestation'],
  },
  {
    id: 'PERSONAL_50',
    ...
    audience: 'B2C',
    badge: '50 invités',
    highlights: ['3 événements · 50 invités', '4 essais IA · recharge de jetons', 'QR, modèles, éditeur 2D/3D complet (80 tables)', '2 salles · hors marketplace'],
  },
  {
    id: 'PERSONAL_100',
    ...
    audience: 'B2C',
    badge: '100 invités',
    highlights: ['3 événements · 100 invités', '4 essais IA · recharge de jetons', 'QR, modèles, éditeur 2D/3D complet (80 tables)', '2 salles · hors marketplace'],
  },
  {
    id: 'PERSONAL_200',
    ...
    highlighted: true,
    badge: '200 invités',
    highlights: ['3 événements · 200 invités', '4 essais IA · recharge de jetons', 'QR, modèles, éditeur 2D/3D complet (80 tables)', '2 salles · hors marketplace'],
  },
  {
    id: 'PERSONAL_PLUS',
    ms365Name: 'Particulier +200',
  ...
  },
  {
    ...
    tier: 'business',
    audience: 'B2B',
    highlights: ['8 événements · 150 invités', '4 essais IA · recharge de jetons', '3 salles · éditeur Business (16 tables)'],
  },
  {
    id: 'PREMIUM_1',
    ms365Name: 'Premium',
    ...
    tier: 'premium',
    audience: 'B2B',
    highlights: ['12 événements · 500 invités', '4 essais IA · recharge de jetons', '5 salles · éditeur Premium (36 tables)'],
  },
  {
    id: 'PREMIUM_2',
    ...
    highlights: ['20 événements · 1 000 invités', '4 essais IA · recharge de jetons', '10 salles · éditeur Premium (36 tables)'],
  },
  {
    id: 'ENTERPRISE_1',
    ...
    tier: 'enterprise',
    audience: 'B2B',
    highlights: ['40 événements · 3 500 invités', '4 essais IA · recharge de jetons', '25 salles · éditeur complet (80 tables)'],
  },
  {
    id: 'ENTERPRISE_2',
    ...
    tier: 'enterprise',
    audience: 'B2B',
    highlights: ['70 événements · 5 000 invités', '4 essais IA · recharge de jetons', '50 salles · éditeur complet (80 tables)'],
  },
  {
    id: 'ENTERPRISE_3',
