...
export const LANDING_PLANS: LandingPlan[] = [
  ...
  },
  {
    ...
    ctaVariant: 'primary',
    tier: 'enterprise',
    highlights: ['35 événements · 1 200 invités', 'Éditeur salle complet', '20 salles · support prioritaire'],
  },
  {
    id: 'ENTERPRISE_2',
    ...
    ctaVariant: 'primary',
    tier: 'enterprise',
    highlights: ['60 événements · 2 500 invités', 'Réseau commercial 20 %', '40 salles · support dédié'],
  },
  {
    id: 'ENTERPRISE_3',
