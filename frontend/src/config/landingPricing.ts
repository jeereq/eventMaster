...
export const LANDING_PLANS: LandingPlan[] = [
  ...
  },
  {
    ...
    tier: 'business',
    audience: 'B2B',
    highlights: ['8 événements · 150 invités / mois', '4 essais IA · recharge de jetons', '3 salles · éditeur Business (16 tables)'],
  },
  {
    id: 'PREMIUM_1',
    ms365Name: 'Premium',
    ...
    tier: 'premium',
    audience: 'B2B',
    highlights: ['12 événements · 500 invités / mois', '4 essais IA · recharge de jetons', '5 salles · éditeur Premium (36 tables)'],
  },
  {
    id: 'PREMIUM_2',
    ...
    highlights: ['20 événements · 1 000 invités / mois', '4 essais IA · recharge de jetons', '10 salles · éditeur Premium (36 tables)'],
  },
  {
    id: 'ENTERPRISE_1',
    ...
    tier: 'enterprise',
    audience: 'B2B',
    highlights: ['40 événements · 3 500 invités / mois', '4 essais IA · recharge de jetons', '25 salles · éditeur complet (80 tables)'],
  },
  {
    id: 'ENTERPRISE_2',
    ...
    tier: 'enterprise',
    audience: 'B2B',
    highlights: ['70 événements · 5 000 invités / mois', '4 essais IA · recharge de jetons', '50 salles · éditeur complet (80 tables)'],
  },
  {
    id: 'ENTERPRISE_3',
    ...
    audience: 'B2B',
    badge: 'Sur-mesure',
    highlights: ['Quotas illimités', '4 essais IA · recharge de jetons', 'SLA 24/7 · éditeur complet (80 tables)'],
  },
  {
    id: 'VENUE',
    ms365Name: 'Salle',
