...
export default function Button({
  ...
  const classes = cn(
    'inline-flex items-center justify-center font-medium transition duration-120 touch-manipulation select-none active:scale-[0.98] motion-reduce:active:scale-100 motion-reduce:transition-none',
