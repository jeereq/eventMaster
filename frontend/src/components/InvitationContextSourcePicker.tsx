...
export default function InvitationContextSourcePicker({
  ...
  return (
    <fieldset className="min-w-0">
      ...
      <p className="hidden sm:block mt-0.5 text-[11px] text-muted leading-relaxed">
        ...
        {OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center sm:items-start gap-2.5 rounded-xl border px-3 py-2.5 text-left transition touch-manipulation',
