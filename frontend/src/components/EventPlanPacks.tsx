        ...
        <div className="flex flex-wrap items-center gap-x-3 pl-14 sm:pl-[3.75rem]">
          {onKeep ? (
            <button
              type="button"
              onClick={() => onKeep(item)}
              className="inline-flex items-center gap-1 min-h-11 px-1 text-xs font-semibold text-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded-sm"
            >
          ...
          {alternatives.length > 0 ? (
            <button
              ...
              aria-expanded={open}
              className="inline-flex items-center gap-1 min-h-11 px-1 text-xs font-semibold text-primary-solid hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded-sm"
            >
        ...
        return (
          <article key={pack.id} className="bg-surface border border-border rounded-[var(--radius-card)] p-4 flex flex-col gap-5">
            <header className="flex flex-col gap-1.5">
              ...
              <p className={cn('text-xs tabular-nums', pack.overBudget ? 'text-danger' : 'text-muted')}>
                {pack.overBudget
