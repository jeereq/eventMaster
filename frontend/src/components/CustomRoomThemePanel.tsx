  ...
  return (
    <div className="space-y-2 pt-2 border-t border-slate-200">
      <div className="flex items-center justify-between gap-2">
        <p className="text-[10px] font-bold uppercase text-slate-500">Thèmes personnalisés</p>
        <button
          type="button"
          onClick={() => setEditing((v) => !v)}
          className="inline-flex items-center gap-1 px-2 py-1 rounded-lg border border-indigo-200 bg-indigo-50 text-indigo-700 text-[10px] font-bold hover:bg-indigo-100"
        >
      ...
      {editing && (
        <div className="p-3 bg-white rounded-xl border border-indigo-100 space-y-2">
          <label className="block text-[10px] space-y-0.5">
            <span className="font-semibold text-slate-600">Nom du thème</span>
            <input
              value={draft.name ?? ''}
          ...
          <div className="grid grid-cols-2 gap-2">
            <label className="text-[10px] space-y-0.5">
              <span className="font-semibold text-slate-600">Couleur accent</span>
            ...
            <label className="text-[10px] space-y-0.5">
              <span className="font-semibold text-slate-600">Tables</span>
          ...
          <label className="block text-[10px] space-y-0.5">
            <span className="font-semibold text-slate-600">Fond du canvas</span>
          ...
          <label className="block text-[10px] space-y-0.5">
            <span className="font-semibold text-slate-600">Type de sol</span>
            <select
          ...
          <button
            ...
            className="w-full py-2 rounded-lg bg-indigo-600 text-white text-[10px] font-bold flex items-center justify-center gap-1 disabled:opacity-50"
          >
