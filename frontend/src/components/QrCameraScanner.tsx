...
export default function QrCameraScanner({ active, onScan, onError }: QrCameraScannerProps) {
 ...
 <div className="relative overflow-hidden rounded-2xl border border-border dark:border-border bg-black min-h-[240px]">
 <div id={regionId} className="w-full [&>video]:rounded-2xl [&>video]:w-full [&>video]:object-cover" />
 {starting && (
 <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-background/70 text-white">
