    ...
    <div ref={rootRef} className={cn('relative', className)}>
      <Tooltip content="Accent personnel (cet appareil)" side="bottom">
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className={cn(
            'p-2.5 sm:p-2 min-w-[44px] min-h-[44px] sm:min-w-[36px] sm:min-h-[36px] flex items-center justify-center rounded-lg text-muted hover:bg-surface-muted hover:text-foreground transition active:scale-95 touch-manipulation cursor-pointer',
