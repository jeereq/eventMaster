      ...
      footer={invoice ? (
        <>
          <button
            ...
            className="flex-1 sm:flex-none min-w-0 px-4 py-2.5 bg-primary hover:bg-primary/90 text-white text-xs font-bold rounded-xl transition flex items-center justify-center gap-2 disabled:opacity-50"
          >
            ...
            <>
                    ...
                    {invoice.commissions.map((c) => (
                      <li key={c.id} className="flex items-center justify-between text-sm gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-muted">{c.commissionRatePercent} % · {c.source}</p>
                        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                ...
                <div className="bg-surface-muted p-3 rounded-xl border border-border">
                  ...
                  <p className="text-[10px] text-muted font-mono">{invoice.plan}</p>
                </div>
                <div className="bg-surface-muted p-3 rounded-xl border border-border">
                  <span className="text-[10px] font-bold text-muted uppercase">Type</span>
              ...
              <div className="border-t border-border pt-4 space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    ...
                    disabled={sending}
                    className="w-full sm:w-auto px-4 py-2.5 bg-primary hover:bg-primary/90 text-white text-xs font-bold rounded-xl transition flex items-center justify-center gap-1.5 disabled:opacity-50 shrink-0"
                  >
