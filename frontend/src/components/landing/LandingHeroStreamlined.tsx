              ...
              return (
                <li key={item.id}>
                  <button
                    ...
                    className={cn(
                      'group relative w-full min-w-0 text-left overflow-hidden rounded-[var(--radius-card)] border aspect-[5/4] sm:aspect-[4/3] lg:aspect-[4/5] flex flex-col justify-between p-2.5 sm:p-3.5 text-white transition-all duration-300 cursor-pointer touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background',
                      selected
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
            <div className="min-w-0 space-y-1">
              ...
              <h3 id="landing-profile-title" className="em-landing-heading text-base sm:text-lg text-foreground line-clamp-2">
                {profile.title}
              </h3>
