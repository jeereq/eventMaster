          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-1 w-full">
                ...
                {selected ? (
                  <span className="w-5 h-5 rounded-full bg-primary-solid text-primary-foreground flex items-center justify-center text-xs shadow-xs">
            ...
            <li key={profile.id} className="w-full">
              <button
                ...
                className={cn(
                  ...
                  selected
                    ? 'border-2 border-primary bg-surface dark:bg-surface shadow-xs ring-2 ring-primary/30 scale-[1.01] z-10'
              ...
              >
                ...
                {selected && (
                  <span className="absolute top-3.5 right-3.5 w-5 h-5 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs shadow-sm shadow-primary/40">
                    <Check className="w-3 h-3 stroke-[3]" />
                  </span>
                )}
                ...
                <div>
                  <div className="flex items-center gap-2.5 mb-2.5">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-muted px-2 py-0.5 rounded-full bg-surface-muted border border-border/80">
                      {profile.eyebrow}
                    </span>
                  </div>

                  <p className="text-xs font-semibold text-primary/90 mb-1.5 leading-snug">
        ...
        footer={
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
            <div className="flex items-center gap-1.5 text-xs text-muted">
              <ShieldCheck className="w-3.5 h-3.5 text-primary-solid shrink-0" />
      ...
      >
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <p className="text-xs font-bold uppercase tracking-wider text-muted inline-flex items-center gap-1.5">
