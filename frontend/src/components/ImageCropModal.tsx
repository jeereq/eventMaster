...
export default function ImageCropModal({
 ...
 <span className="text-xs font-semibold text-muted mb-1 block">Choisir une image</span>
 <input
 type="file"
 accept="image/*"
 ...
 {sourceUrl && (
 <>
 <div className="relative w-full aspect-video bg-surface-muted dark:bg-background rounded-xl overflow-hidden border border-border dark:border-border">
