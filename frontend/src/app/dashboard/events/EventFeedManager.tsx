...
export default function EventFeedManager({ eventId }: EventFeedManagerProps) {
 ...
 <p className="text-muted dark:text-muted text-sm max-w-xl">
 ...
 className="inline-flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-background border border-border dark:border-border hover:bg-surface-muted dark:hover:bg-surface-muted text-muted dark:text-foreground font-semibold rounded-xl text-xs transition shadow-xs"
 >
 ...
 <div className="bg-white dark:bg-background border border-border dark:border-border rounded-2xl p-4 flex items-center gap-3 shadow-xs">
 <div className="bg-primary/10 dark:bg-primary/15 text-primary dark:text-primary p-2.5 rounded-xl">
 <Rss className="w-5 h-5" />
 </div>
 <div>
 <div className="text-[10px] font-bold text-muted dark:text-muted uppercase tracking-wider">Publications</div>
 <div className="text-xl font-black text-foreground dark:text-foreground">{posts.length}</div>
 </div>
 </div>
 <div className="bg-white dark:bg-background border border-border dark:border-border rounded-2xl p-4 flex items-center gap-3 shadow-xs">
 ...
 <div>
 <div className="text-[10px] font-bold text-muted dark:text-muted uppercase tracking-wider">Livre d'or</div>
 <div className="text-xl font-black text-foreground dark:text-foreground">{shares.length}</div>
 </div>
 </div>
 <div className="bg-white dark:bg-background border border-border dark:border-border rounded-2xl p-4 flex items-center gap-3 shadow-xs">
 <div className="bg-primary/10 dark:bg-primary/15 text-primary dark:text-primary p-2.5 rounded-xl">
 ...
 <div>
 <div className="text-[10px] font-bold text-muted dark:text-muted uppercase tracking-wider">Commentaires</div>
 <div className="text-xl font-black text-foreground dark:text-foreground">{totalComments}</div>
 </div>
 </div>
 <div className="bg-white dark:bg-background border border-border dark:border-border rounded-2xl p-4 flex items-center gap-3 shadow-xs">
 ...
 <div>
 <div className="text-[10px] font-bold text-muted dark:text-muted uppercase tracking-wider">J'aime</div>
 <div className="text-xl font-black text-foreground dark:text-foreground">{totalLikes}</div>
 </div>
 </div>
 </div>

 {/* Sub-tabs */}
 <div className="flex gap-2 p-1 bg-surface-muted dark:bg-background border border-border dark:border-border rounded-2xl w-fit">
 <button
 onClick={() => setActiveSubTab('feed')}
 className={`px-5 py-2.5 text-xs font-bold rounded-xl transition flex items-center gap-2 ${
 activeSubTab === 'feed'
 ? 'bg-white dark:bg-surface-muted text-primary dark:text-primary shadow-sm'
 : 'text-muted dark:text-muted hover:text-foreground dark:hover:text-white'
 }`}
 >
 ...
 className={`px-5 py-2.5 text-xs font-bold rounded-xl transition flex items-center gap-2 ${
 activeSubTab === 'shares'
 ? 'bg-white dark:bg-surface-muted text-rose-600 dark:text-rose-400 shadow-sm'
 : 'text-muted dark:text-muted hover:text-foreground dark:hover:text-white'
 }`}
 >
 ...
 {/* Create Post */}
 <div className="lg:col-span-1 bg-white dark:bg-background border border-border dark:border-border rounded-3xl p-6 shadow-xs space-y-4 sticky top-6">
 <h3 className="font-extrabold text-foreground dark:text-foreground text-sm flex items-center gap-2">
 ...
 rows={4}
 className="w-full px-4 py-3 bg-surface-muted dark:bg-background border border-border dark:border-border rounded-xl text-sm focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition resize-none text-foreground dark:text-foreground placeholder:text-muted"
 />
 ...
 <div key={idx} className="relative aspect-square rounded-xl overflow-hidden border border-border dark:border-border bg-surface-muted dark:bg-surface-muted">
 {file.type === 'VIDEO' ? (
 ...
 {isUploading && (
 <div className="flex items-center justify-center gap-2 py-3 bg-surface-muted dark:bg-background border border-dashed border-border dark:border-border rounded-xl">
 <Loader2 className="w-4 h-4 text-primary animate-spin" />
 <span className="text-xs font-semibold text-muted">Encodage des fichiers...</span>
 </div>
 )}

 <div className="flex items-center justify-between gap-3 pt-2 border-t border-border-subtle dark:border-border">
 <label className="inline-flex items-center gap-1.5 px-3 py-2 bg-surface-muted dark:bg-surface-muted hover:bg-surface-muted dark:hover:bg-surface-muted text-foreground dark:text-foreground font-semibold rounded-xl text-xs cursor-pointer transition">
 ...
 {loadingPosts ? (
 <div className="bg-white dark:bg-background border border-border dark:border-border rounded-3xl p-12 flex flex-col items-center justify-center gap-3">
 <Loader2 className="w-8 h-8 text-primary animate-spin" />
 <p className="text-sm font-medium text-muted">Chargement du fil d'actualité...</p>
 </div>
 ) : posts.length === 0 ? (
 <div className="bg-white dark:bg-background border border-border dark:border-border rounded-3xl p-12 text-center space-y-3">
 ...
 <h4 className="font-bold text-foreground dark:text-foreground">Aucune publication</h4>
 <p className="text-muted dark:text-muted text-sm max-w-sm mx-auto">
 ...
 return (
 <article key={post.id} className="bg-white dark:bg-background border border-border dark:border-border rounded-3xl overflow-hidden shadow-xs">
 {/* Post header */}
 ...
 <div>
 <span className="font-extrabold text-foreground dark:text-foreground text-sm block">Organisateur</span>
 <span className="text-[10px] text-muted font-medium">{formatRelativeDate(post.createdAt)}</span>
 </div>
 </div>
 ...
 className="p-2 text-muted hover:text-primary hover:bg-primary/10 dark:hover:bg-primary/10 rounded-xl transition"
 ...
 className="p-2 text-muted hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 rounded-xl transition"
 title="Supprimer"
 >
 ...
 {post.content && (
 <p className="px-5 pt-4 text-foreground dark:text-foreground text-sm leading-relaxed whitespace-pre-line">
 {post.content}
 </p>
 )}
 ...
 {/* Engagement bar */}
 <div className="px-5 py-3 mt-2 flex items-center gap-4 border-b border-border-subtle dark:border-border">
 ...
 <span className="inline-flex items-center gap-1.5 text-xs font-bold text-muted dark:text-muted">
 ...
 <div className="w-7 h-7 rounded-full bg-surface-muted dark:bg-surface-muted border border-border dark:border-border flex items-center justify-center font-bold text-muted dark:text-muted text-[10px] flex-shrink-0">
 {comment.authorName[0]?.toUpperCase()}
 </div>
 <div className="flex-1 bg-surface-muted dark:bg-background border border-border-subtle dark:border-border rounded-2xl rounded-tl-sm px-3.5 py-2.5">
 <div className="flex items-center justify-between gap-2 mb-0.5">
 <span className="font-extrabold text-foreground dark:text-foreground text-xs">{comment.authorName}</span>
 <span className="text-[9px] text-muted">{formatRelativeDate(comment.createdAt)}</span>
 </div>
 <p className="text-muted dark:text-muted text-xs leading-relaxed">{comment.content}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 className="flex-1 px-4 py-2.5 bg-surface-muted dark:bg-background border border-border dark:border-border rounded-xl text-xs focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 text-foreground dark:text-foreground"
 />
 <button
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-background border border-border dark:border-border rounded-xl text-sm focus:outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 text-foreground dark:text-foreground"
 />
 </div>
 )}
 ...
 <p className="text-sm font-medium text-muted">Chargement du livre d'or...</p>
 </div>
 ) : shares.length === 0 ? (
 ...
 <div className="inline-flex items-center justify-center bg-white dark:bg-background p-5 rounded-full text-rose-500 shadow-md">
 <BookOpen className="w-10 h-10" />
 </div>
 <div>
 <h4 className="font-black text-foreground dark:text-foreground text-lg">Le livre d'or est vide</h4>
 <p className="text-muted dark:text-muted text-sm max-w-sm mx-auto mt-2">
 Les messages et photos partagés par vos invités depuis leur portail RSVP apparaîtront ici.
 </p>
 </div>
 </div>
 ) : filteredShares.length === 0 ? (
 <div className="text-center py-12 text-muted dark:text-muted text-sm">
 ...
 <article
 key={share.id}
 className="bg-white dark:bg-background border border-border dark:border-border rounded-3xl overflow-hidden shadow-xs hover:shadow-md transition-shadow flex flex-col"
 >
 ...
 <span className="font-extrabold text-foreground dark:text-foreground text-sm block truncate">
 {share.guest.firstName} {share.guest.lastName}
 </span>
 <span className="text-[10px] text-muted font-medium">{formatRelativeDate(share.createdAt)}</span>
 </div>
 {photosList.length > 0 && (
 <button
 type="button"
 ...
 disabled={isBulkDownloading}
 className="p-2 text-muted hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 rounded-xl transition flex-shrink-0"
 ...
 <p className="text-foreground dark:text-foreground text-sm leading-relaxed italic pt-1">
 {share.message}
 </p>
 </blockquote>
 )}
 ...
 <div
 key={idx}
 className={`relative overflow-hidden bg-surface-muted dark:bg-surface-muted group cursor-pointer ${
 ...
 <div className="mt-auto pt-3 border-t border-border-subtle dark:border-border">
 <span className="text-[10px] text-muted font-medium truncate block">{share.guest.email}</span>
 </div>
 </div>
 </article>
 );
