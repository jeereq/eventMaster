...
type FeedKind = 'all' | 'venue' | 'vendor';
...
export default function MarketplaceActivityPage() {
  ...
  const load = useCallback(async (opts?: { cursor?: string | null; kind?: FeedKind; q?: string }) => {
  ...
  const kindTabs: Array<{ id: FeedKind; label: string }> = [
    { id: 'all', label: 'Tout' },
