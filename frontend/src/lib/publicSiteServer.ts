...
const DEFAULT_DESCRIPTION =
  'Invitez par WhatsApp, SMS ou e-mail, placez, accueillez. Trouvez une salle ou un prestataire. Confirmations de présence, plan de table et scan QR dans le navigateur.';
