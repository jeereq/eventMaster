...
export const LANDING_PROFILES: LandingProfile[] = [
  ...
  },
  {
    ...
    intro: 'Créez votre billetterie en ligne, encaissez les paiements par Mobile Money (Orange Money, M-Pesa, Airtel, Afrimoney) ou Carte, validez automatiquement les présences et contrôlez les entrées avec votre smartphone.',
