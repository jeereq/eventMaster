...
export const LANDING_PROFILES: LandingProfile[] = [
  {
    ...
    results: [
      { icon: Heart, label: 'Faire-part IA envoyés par WhatsApp, SMS ou e-mail' },
    ...
    steps: [
      ...
      {
        title: '2. Envoyer les invitations',
        description: 'Lien unique par invité, sans application.',
        detail: 'Envoyez vos invitations en 1 clic par WhatsApp, SMS ou e-mail. Vos convives confirment leur présence et personnalisent leurs coordonnées.',
