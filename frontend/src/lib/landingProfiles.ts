...
export const LANDING_PROFILES: LandingProfile[] = [
  ...
  },
  {
    ...
    intro: 'Billetterie en ligne, encaissements Mobile Money et contrôle d’accès smartphone.',
    ...
    registerHint: 'Événements payants ou avec contrôle d’accès. Sans matériel coûteux.',
    results: [
  ...
  },
  {
    ...
    targetAudience: 'Recherche de salle, traiteur, DJ ou photographe',
    title: 'Trouvez salle et prestataires',
    intro: 'Salles avec visite 3D, formules transparentes et devis directs sans commission.',
  ...
  },
  {
    ...
    targetAudience: 'Salles de réception et prestataires certifiés',
    title: 'Publiez votre salle ou vos prestations',
    intro: 'Vitrine avec visite 3D, devis directs et planning sans commission.',
    ...
    registerHint: 'Visibilité ciblée, devis directs sans commission.',
    results: [
