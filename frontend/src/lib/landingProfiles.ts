...
export const LANDING_PROFILES: LandingProfile[] = [
  ...
  {
    id: 'pro',
    label: 'Pro & Billetterie',
    shortLabel: 'Pro & Agence',
    eyebrow: 'Professionnel',
    title: 'Billetterie, zones de prix et accueil Jour J',
    ...
    steps: [
      {
        ...
        detail: 'Définissez le plan de salle avec tarification par zone. Paiements sécurisés en CDF.',
        outcome: 'Billetterie en ligne prête.',
        icon: CalendarCheck,
      },
      {
        title: '2. Encaisser en direct',
        description: 'M-Pesa, Orange Money, Airtel et cartes.',
        detail: 'Les acheteurs choisissent leur place et reçoivent immédiatement leur badge QR.',
        outcome: 'Recettes et billets automatiques.',
        icon: Wallet,
      },
      {
        title: '3. Coordonner l’équipe',
        description: 'Accès dédiés pour managers et agents d’accueil.',
        detail: 'Attribuez des rôles précis. Suivez les présences et les encaissements en direct.',
      ...
      },
      {
        ...
        detail: 'Scanner intégré pour l’accueil. Affichage instantané du siège et émargement en direct.',
        outcome: 'Émargement en temps réel.',
        icon: ScanLine,
      },
    ],
  },
  {
    ...
    intro: 'Explorez les salles avec visite 3D et contactez les professionnels en direct.',
  ...
  },
  {
    ...
    results: [
      { icon: LayoutGrid, label: 'Vitrine 3D & Devis' },
      { icon: MessageSquare, label: 'Demandes directes' },
      { icon: CalendarCheck, label: 'Planning de dates' },
    ],
    icon: Building2,
