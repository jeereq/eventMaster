...
4. **Invités & Acheteurs de Billets (Mobile End-Users)** : Répondent aux invitations réponse à l’invitation ou achètent des billets en ligne via Mobile Money (M-Pesa, Orange, Airtel, Afrimoney) ou Carte bancaire (Visa/Mastercard), avec accès immédiat à leur Pass QR.
...
- Distribution des invitations et collecte des confirmations de présence en temps réel (WhatsApp, SMS, Email).
...
- **Canal WhatsApp et réponses à l’invitation** : Invitations personnalisées avec liens sécurisés uniques, choix de repas et restriction d'accès.
